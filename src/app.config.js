const AppConfig = ($provide, $httpProvider, $stateProvider, $locationProvider, $urlRouterProvider) => {
    'ngInject';
    ...
    // this change the classes of the icons for the tools for font-awesome v3.x
